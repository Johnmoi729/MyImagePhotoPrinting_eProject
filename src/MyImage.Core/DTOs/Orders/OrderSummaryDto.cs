...
/// UPDATED: Added PaymentStatus property for Stripe integration.
/// </summary>
public class OrderSummaryDto
{
    ...
    /// <summary>
    /// ADDED: Payment processing status from Stripe
    /// Values: "pending", "processing", "verified", "failed", "refunded"
    /// Used to show payment status in order history
    /// </summary>
