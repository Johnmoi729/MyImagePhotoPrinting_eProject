...
public interface IOrderRepository
{
    ...
    /// Used when admin wants to see complete order list without filtering.
    /// </summary>
    /// <param name="page">Page number</param>
    /// <param name="pageSize">Items per page</param>
    /// <returns>Paginated orders sorted by creation date</returns>
    Task<PagedResult<Order>> GetAllOrdersAsync(int page, int pageSize);

    /// <summary>
    /// Find order by Stripe Payment Intent ID.
    /// Used for webhook processing to locate orders by Stripe references.
    /// </summary>
    ...
    /// <param name="page">Page number</param>
    /// <param name="pageSize">Items per page</param>
    /// <returns>Paginated orders in date range</returns>
    Task<PagedResult<Order>> GetOrdersByDateRangeAsync(DateTime fromDate, DateTime toDate, int page, int pageSize);
