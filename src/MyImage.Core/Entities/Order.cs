...
/// <summary>
/// Payment information and processing status
/// Implements Requirement 3: encrypted credit card handling, Enhanced payment information with Stripe integration support.
...
public class OrderPayment
{
    ...
    /// <summary>
    /// ADDED: Stripe Payment Intent ID for tracking and refunds
    /// Links order to Stripe Payment Intent for full lifecycle management
    /// </summary>
    [BsonElement("stripePaymentIntentId")]
    public string? StripePaymentIntentId { get; set; }

    /// <summary>
    /// ADDED: Stripe Customer ID for returning customer management
    /// Enables saved payment methods and customer history in Stripe
    /// </summary>
    [BsonElement("stripeCustomerId")]
    public string? StripeCustomerId { get; set; }

    /// <summary>
    /// ADDED: Stripe Charge ID for completed payments
    ...
    /// <summary>
    /// ADDED: Processing fee charged by Stripe
    /// Important for accounting and reconciliation
    /// </summary>
    [BsonElement("stripeProcessingFee")]
